type SidebarFilledSvgProps = React.HTMLAttributes<SVGElement>;

export function SidebarFilledSvg(props: SidebarFilledSvgProps) {
  return (
    <svg
      {...props}
      ...
      xmlSpace="preserve"
    >
      <rect id="Icons" x="0" y="-64" width="1280" height="800" style={{ fill: "none" }} />

      <g id="Icons1" {...{ "serif:id": "Icons" }}>
        <rect x="11.014" y="12.074" width="15.012" height="43" />
        <path
          id="sidebar"
