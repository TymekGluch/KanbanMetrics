...
export type PostApiAccountActivationCodeActivateRequestBody = NonNullable<ApiPaths["/api/account-activation-code/activate"]["post"]["requestBody"]>["content"]["*/*"];
export type PostApiAccountActivationCodeActivateResponse200 = ApiPaths["/api/account-activation-code/activate"]["post"]["responses"][200]["content"]["application/json"];
...
export type GetApiAccountActivationCodeGetResponse401 = ApiPaths["/api/account-activation-code/get"]["get"]["responses"][401]["content"]["application/json"];
export type GetApiAccountActivationCodeGetResponse500 = ApiPaths["/api/account-activation-code/get"]["get"]["responses"][500]["content"]["application/json"];

export type PostApiAuthLoginRequestBody = NonNullable<ApiPaths["/api/auth/login"]["post"]["requestBody"]>["content"]["application/json"];
...
export type PostApiAuthRegisterRequestBody = NonNullable<ApiPaths["/api/auth/register"]["post"]["requestBody"]>["content"]["application/json"];
...
export type PutApiUserUpdateRequestBody = NonNullable<ApiPaths["/api/user/update"]["put"]["requestBody"]>["content"]["application/json"];
...
export type GetApiWorkspacesRequestBody = NonNullable<ApiPaths["/api/workspaces"]["get"]["requestBody"]>["content"]["application/json"];
...
export type PostApiWorkspacesCreateRequestBody = NonNullable<ApiPaths["/api/workspaces/create"]["post"]["requestBody"]>["content"]["application/json"];
