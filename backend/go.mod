...
require (
	...
	github.com/TymekGluch/Morphyxis-mail-service v0.0.0-20260712181146-c329db083618 // indirect
	...
	github.com/go-openapi/swag/jsonutils/fixtures_test v0.27.0 // indirect
